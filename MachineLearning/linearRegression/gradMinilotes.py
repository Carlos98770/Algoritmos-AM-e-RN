...
class LinearRegression():
    ...
    def fit(self,n_interations,t0,t1,lote) -> None:
        m = len(self.__X)
        self.__t0 = t0
        self.__t1 = t1
        for epoch in range(n_interations):
            for i in range(m):
                ...
                #Verificar sem random_index+lote está no intervalo do vetor
                xi = self.__X[random_index:random_index+lote]
                yi = self.__y[random_index:random_index+lote]
